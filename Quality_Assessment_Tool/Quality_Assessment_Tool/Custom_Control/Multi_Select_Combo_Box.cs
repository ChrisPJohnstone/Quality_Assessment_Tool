...
namespace Quality_Assessment_Tool
{
    public class MultiSelectComboBox : ComboBox
    {
        internal class Dropdown : Form
        {
            ...
            internal class CustomCheckedListBox : CheckedListBox
            {
                ...
                protected override void OnKeyDown(KeyEventArgs e)
                {
                    ...
                    {
                        ((MultiSelectComboBox.Dropdown)Parent).OnDeactivate(new CCBoxEventArgs(null, true));
                        e.Handled = true;

                    }
                    else if (e.KeyCode == Keys.Escape)
                    {
                        ((MultiSelectComboBox.Dropdown)Parent).OnDeactivate(new CCBoxEventArgs(null, false));
                        e.Handled = true;
            ...
            private MultiSelectComboBox ccbParent;
            ...
            public Dropdown(MultiSelectComboBox ccbParent)
            {
            ...
            ///       MultiSelectComboBox (after the dropdown has closed) to determine any actual value changes.
            /// </summary>
            ...
            public void CloseDropdown(bool enactChanges)
            {
                ...
                dropdownClosed = true;
                // Set the focus to our parent MultiSelectComboBox and hide the dropdown check list.
                ccbParent.Focus();
                this.Hide();
                // Notify MultiSelectComboBox that its dropdown is closed. (NOTE: it does not matter which parameters we pass to
        ...
        // text portion of the MultiSelectComboBox.
        ...
        private void DoDropDown()
        {
            if (!dropdown.Visible)
            {
                ...
                dropdown.Size = new Size(250, (dropdown.List.ItemHeight) * count + 2);
                dropdown.Show(this);
            }
        }
    ...
    } // end public class MultiSelectComboBox
